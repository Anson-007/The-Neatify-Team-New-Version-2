          ...
          <div className="summary">
            ...
            <div className="services-wrapper">
              {selectedServices.map((s, i) => (
                <div key={i} className="service-item">
                  ...
                  <p>{getCurrency(s.price)}{formatPrice(s.price)}</p>
                  {s.original_price && <p className="mrp">{getCurrency(s.original_price)}{formatPrice(s.original_price)}</p>}
            ...
            <div className="total-row">
              ...
              <div>
                ...
                {originalTotalAmount > totalAmount && <p className="mrp">{currency}{originalTotalAmount}</p>}
                <span className="offer-badge">
